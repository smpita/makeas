...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/makeas.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/makeas)
...
```bash
php artisan vendor:publish --tag="makeas-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="makeas-config"
```
...
```bash
php artisan vendor:publish --tag="makeas-views"
```

## Usage

```php
$makeAs = new Smpita\MakeAs();
echo $makeAs->echoPhrase('Hello, Smpita!');
```
